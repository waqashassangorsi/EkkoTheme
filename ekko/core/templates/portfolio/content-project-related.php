 ...
 */
  ...
  if ($terms == 0) {
	...
	$related_query = new WP_Query(
		array(
			...
			'posts_per_page' => ekko_get_option( 'tek-portfolio-related-posts-number' ),
  ...
  if ( $related_query->found_posts > 3 && ekko_get_option( 'tek-portfolio-related-posts-number' ) > 3) {
...
<section class="related-posts">
  <div class="container">
    <?php if ( '' != ekko_get_option( 'tek-portfolio-related-posts-title' ) ) : ?>
      <div class="related-title">
        <h3><?php echo esc_html( ekko_get_option( 'tek-portfolio-related-posts-title' ) ); ?></h3>
      </div>
    <?php endif; ?>
